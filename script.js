...
async function initDashboardPage() {
  ...
  const sideOptionsModal = document.getElementById("sideOptionsModal");
  if (startGameBtn && sideOptionsModal) {
    startGameBtn.addEventListener("click", () => {
      sideOptionsModal.classList.remove("hidden");
    });
  }

  const colorModalCard = document.getElementById("colorModalCard");
  const playWhiteBtn = document.getElementById("playWhiteBtn");
  const playBlackBtn = document.getElementById("playBlackBtn");

  if (colorModalCard && playWhiteBtn && playBlackBtn) {
    playWhiteBtn.addEventListener("mouseenter", () => colorModalCard.classList.add("theme-white"));
    playWhiteBtn.addEventListener("mouseleave", () => colorModalCard.classList.remove("theme-white"));
    
    playBlackBtn.addEventListener("mouseenter", () => colorModalCard.classList.add("theme-black"));
    playBlackBtn.addEventListener("mouseleave", () => colorModalCard.classList.remove("theme-black"));
  }

  if (playWhiteBtn) {
    playWhiteBtn.addEventListener("click", () => {
      if (sideOptionsModal) sideOptionsModal.classList.add("hidden");
